...
const NewsLatterBox = () => {
  ...
  return (
    <div
      ...
      data-wow-delay=".2s"
    >
      <h3 className="mb-4 text-4xl md:text-5xl font-bold leading-tight text-black dark:text-white">
        Join the Waitlist
      </h3>
      <p className="mb-11 md:text-2xl border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-black dark:text-white dark:border-white dark:border-opacity-25">
